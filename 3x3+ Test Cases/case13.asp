...
init(object(pickingStation,2),value(at,pair(3,2))).
init(object(pickingStation,3),value(at,pair(3,3))).

init(object(robot,1),value(at,pair(1,1))).
init(object(robot,2),value(at,pair(1,2))).
init(object(robot,3),value(at,pair(1,3))).
...
init(object(highway,2),value(at,pair(1,2))).
init(object(highway,3),value(at,pair(1,3))).

init(object(product,1),value(on,pair(1,500))).
init(object(product,2),value(on,pair(2,500))).
init(object(product,3),value(on,pair(3,500))).
...
init(object(order,2),value(line,pair(2,500))).

init(object(order,3),value(pickingStation,1)).
init(object(order,3),value(line,pair(3,500))).
