...
init(object(shelf,4),value(at,pair(2,3))).
init(object(shelf,5),value(at,pair(3,1))).

init(object(product,1),value(on,pair(1,200))).
init(object(product,1),value(on,pair(2,200))).
init(object(product,1),value(on,pair(4,200))).
init(object(product,2),value(on,pair(3,200))).
init(object(product,2),value(on,pair(5,200))).

init(object(order,1),value(pickingStation,2)).
init(object(order,1),value(line,pair(1,600))).

init(object(order,2),value(pickingStation,1)).
init(object(order,2),value(line,pair(2,400))).
