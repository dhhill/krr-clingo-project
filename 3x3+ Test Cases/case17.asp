...
init(object(robot,3),value(at,pair(3,1))).
init(object(robot,4),value(at,pair(3,3))).

init(object(shelf,1),value(at,pair(1,2))).
init(object(shelf,2),value(at,pair(2,1))).
init(object(shelf,3),value(at,pair(2,3))).
init(object(shelf,4),value(at,pair(3,2))).

init(object(product,1),value(on,pair(1,200))).
init(object(product,2),value(on,pair(2,200))).
init(object(product,3),value(on,pair(3,200))).
init(object(product,4),value(on,pair(4,200))).
...
init(object(order,3),value(line,pair(3,200))).

init(object(order,4),value(pickingStation,1)).
init(object(order,4),value(line,pair(4,200))).
